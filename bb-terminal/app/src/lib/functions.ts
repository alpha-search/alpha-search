...
export const FUNCTIONS: FunctionDef[] = [
  ...
  { code: "BUILD", name: "Universe Builder",     needsSymbol: false, group: "System", summary: "Drag-and-drop stocks to construct your target thematic scanning universe" },
  { code: "SCAN",  name: "Thematic Scanner",     needsSymbol: false, group: "System", summary: "Run Stock Opportunity Agent multi-factor thematic scan" },
];
